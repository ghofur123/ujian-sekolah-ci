...
class Setting extends CI_Controller {
	...
	public function __construct(){
		...
		$this->load->model("crud_function_model");
				...
				echo "
					<link rel='stylesheet' href='http://localhost:8080/uasbnbk/assets/bootstrap.min.css'>
					<script src='http://localhost:8080/uasbnbk/assets/bootstrap/1.12.0_jquery.min.js'></script>
					<script src='http://localhost:8080/uasbnbk/assets/bootstrap/bootstrap.min.js'></script>
				";
...
';for($i = 0; $i < $queryDataRead['jumlah']; $i++){
	...
	if($this->input->post("type-".$i) == "VARCHAR"){
		...
		echo $this->input->post("type-".$i).' NULL, ';
			...
			echo '<textarea style="margin:10px; width:98%; height:100px;border:2px solid #000;">
else if($this->input->get(\'dashboard\') == \'';echo $this->input->post("dbName"); echo '\'){
