...
<body class="hold-transition login-page">
	<div class="callout callout-danger class-message-div" style='position:fixed; width:40%; margin:-50px 0px 0px 30%;'>
		<h4>Perhatian!</h4>
	...
	<div class="login-box">
		...
		<div class="login-box-body">
			<p class="login-box-msg">Assalamulaikum silahkan login untuk memasuki ruang siswa</p>
