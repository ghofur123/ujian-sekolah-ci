...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$(".new-data-class").click(function(){
			...
			$.ajax({
				type : "POST",
				url : "absen_input_guru/load?act=insert",
				data : $(this).serialize(),
				success : function(data){
					ajaxload();
					$(".message-errors").html(data);
					$("#guru_id").val("");$("#time_guru").val("");$("#kode_absen_struktur_guru_id").val("");
				}
			})
			return false;
		});
		...
		$("#form2").submit(function(){
			...
			$.ajax({
				type : "POST",
				url : "absen_input_guru/load?act=update",
				data : $(this).serialize(),
				success : function(data){
					ajaxload();
		...
		$("#search").keyup(function(){
			...
			$.ajax({
				type : "POST",
				url : "absen_input_guru/load?act=search&id=" + id,
				data : $(this).serialize(),
				success : function(data){
	...
	function ajaxload(){
		...
		$.ajax({
			type : "POST",
			url : "absen_input_guru/load?&act=load",
			data : $(this).serialize(),
			success : function(data){
				$("#displaydata").html(data);
			}
						...
						<div class="modal-content">
							<form  method="POST" action="#" id="form" name="form1" >
								...
								<div class="modal-body">
									<input type="text" class="form-control" name="guru_id" id="guru_id" placeholder="guru_id" ><input type="text" class="form-control" name="time_guru" id="time_guru" placeholder="time_guru" ><input type="text" class="form-control" name="kode_absen_struktur_guru_id" id="kode_absen_struktur_guru_id" placeholder="kode_absen_struktur_guru_id" >				
								</div>
