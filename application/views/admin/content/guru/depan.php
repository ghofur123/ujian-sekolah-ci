...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$(".new-data-class").click(function(){
			...
			$.ajax({
				type : "POST",
				url : "guru/load?act=insert",
				data : $(this).serialize(),
				success : function(data){
					ajaxload();
					$(".message-errors").html(data);
					$("#nama_guru").val("");$("#username").val("");$("#password").val("");
				}
			})
			return false;
		});
		...
		$("#search").keyup(function(){
			...
			$.ajax({
				type : "POST",
				url : "guru/load?act=search&id=" + id,
				data : $(this).serialize(),
				success : function(data){
						...
						<div class="modal-content">
							<form  method="POST" action="#" id="form" name="form1" >
								...
								<div class="modal-body">
									<input type="text" selected class="form-control" name="nama_guru" id="nama_guru" placeholder="nama_guru" ><input type="text" class="form-control" name="username" id="username" placeholder="username" ><input type="text" class="form-control" name="password" id="password" placeholder="password" >				
								</div>
