...
$(document).ready(function(){
	$(".delete-class").click(function(){
		...
		if(confirm("Yakin Mau Di Hapus")){
			...
			$.ajax({
				type : "POST",
				url : "profile_sekolah/load?act=delete&id=" + id,
				data : $(this).serialize(),
	...
	$(".view-class").click(function(){
		...
		$.ajax({
				type : "POST",
				url : "profile_sekolah/load?act=view&id=" + id,
				data : $(this).serialize(),
				success : function(data){
					$("#form").hide();
	...
	$(".edit-class").click(function(){
		...
		$.ajax({
				type : "POST",
				url : "profile_sekolah/load?act=viewEdit&id=" + id,
				data : $(this).serialize(),
				success : function(data){
					$("#form").hide();
					$(".view-class-modal").show();
	...
	<table class="table">
		<thead>
		  <tr>
			<th>nama</th><th>kode</th><th>alamat</th><th>kepsek</th><th>no_tlp</th>
			<th>action</th>
		  </tr>
		</thead>
		<tbody>
