...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$(".new-data-class").click(function(){
			...
			$.ajax({
				type : "POST",
				url : "jenis_ujian/load?act=insert",
				data : $(this).serialize(),
				success : function(data){
					ajaxload();
					$(".message-errors").html(data);
					$("#nama_jenis_ujian").val("");
				}
			})
			return false;
		});
		...
		$("#form2").submit(function(){
			...
			$.ajax({
				type : "POST",
				url : "jenis_ujian/load?act=update",
				data : $(this).serialize(),
				success : function(data){
					ajaxload();
		...
		$("#search").keyup(function(){
			...
			$.ajax({
				type : "POST",
				url : "jenis_ujian/load?act=search&id=" + id,
				data : $(this).serialize(),
				success : function(data){
						...
						<div class="modal-content">
							<form  method="POST" action="#" id="form" name="form1" >
								...
								<div class="modal-body">
									<input type="text" class="form-control" name="nama_jenis_ujian" id="nama_jenis_ujian" placeholder="nama_jenis_ujian" >				
								</div>
