...
$(document).ready(function(){
	$(".delete-class").click(function(){
		...
		if(confirm("Yakin Mau Di Hapus")){
			...
			$.ajax({
				type : "POST",
				url : "jenis_ujian/load?act=delete&id=" + id,
				data : $(this).serialize(),
	...
	$(".view-class").click(function(){
		...
		$.ajax({
				type : "POST",
				url : "jenis_ujian/load?act=view&id=" + id,
				data : $(this).serialize(),
				success : function(data){
					$("#form").hide();
	...
	$(".edit-class").click(function(){
		...
		$.ajax({
				type : "POST",
				url : "jenis_ujian/load?act=viewEdit&id=" + id,
				data : $(this).serialize(),
				success : function(data){
					$("#form").hide();
					$(".view-class-modal").show();
	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				<td>
				<?php echo "$item[nama_jenis_ujian]"; ?>
				</td>
				<td>
